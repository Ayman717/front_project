...
export function Meats({navigation}) {
  
  const [fruit, setfruits] = useState([])
  

async function getData(setfruits) {
		let {data} = await axios.get("http://192.168.1.10:5000/meat")
		// console.log(res)
		setfruits(data )
...
//   console.log(data)
  return (
    <View style={{backgroundColor:"white",flex:1}}>
      <ScrollView>
          <AppBar style={{ marginTop: 39, backgroundColor: "#78A206" }} title="Meats" leading={props => (
